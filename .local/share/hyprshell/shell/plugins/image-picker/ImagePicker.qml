...
Item {
  ...
  property string imageDirs: Quickshell.env("HYPRSHELL_IMAGE_SELECTOR_DIRS") || Quickshell.env("HYPRSHELL_IMAGE_SELECTOR_DIR") || Quickshell.env("HYPRSHELL_STOCK_BACKGROUNDS_DIR") || (stateHome + "/hyprshell/current/theme/backgrounds")
  ...
  // Lifecycle hooks invoked by shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "hyprshell-image-selector"
