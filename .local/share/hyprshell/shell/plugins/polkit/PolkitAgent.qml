...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    id: polkitAgent
    path: "/org/hyprshell/PolkitAgent"
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("hyprshell polkit agent registered")
      else console.warn("hyprshell polkit agent is not registered; another agent may be running")
    }
  }
