...
QtObject {
  ...
  readonly property string currentThemePath: stateHome + "/hyprshell/current/theme"

  // Static palette — no live theme-switching. Accent matches the cyan/green
  // gradient used for Hyprland window borders. Edit directly to restyle.
  ...
  property FileView userShellFile: FileView {
    id: userShellFile
    path: root.home + "/.config/hyprshell/shell.toml"
    watchChanges: true
    printErrors: false
